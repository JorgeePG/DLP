...
/*
	...
	expr -> lvalue:boolean
*/
public class OperacionAritmetica extends AbstractExpr  {
	...
	public OperacionAritmetica(Expr left, String operador, Expr right) {
		super();
	...
	public OperacionAritmetica(Object left, Object operador, Object right) {
		super();
    ...
    public String toString() {
        return "OperacionAritmetica{" + " left=" + this.getLeft() + " operador=" + this.getOperador() + " right=" + this.getRight() + "}";
    }
