...
/*
	...
	expr -> 
*/
public class Comparacion extends AbstractExpr  {
	...
	public Comparacion(Expr left, String operador, Expr right) {
		super();
    ...
    public String toString() {
        return "Comparacion{" + " left=" + this.getLeft() + " operador=" + this.getOperador() + " right=" + this.getRight() + "}";
    }
