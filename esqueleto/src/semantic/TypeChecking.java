    ...
    */
	...
	// class Return(Optional<Expr> expr)
 	...
 	public Object visit(Return returnValue, Object param) {
 		...
 		predicate(returnValue.getPadre().getTipoRetorno().getClass().equals(new VoidType().getClass()) && returnValue.getExpr().isEmpty(),
 				"El tipo de retorno de la función es void y se está intentando devolver una tipo diferente",
 				returnValue);
 	...
 	public Object visit(StmtFunctionCall stmtFunctionCall, Object param) {
 		...
 		predicate(!(stmtFunctionCall.getExprs().size()!=stmtFunctionCall.getFunction().parametros().count()),
 	...
 	public Object visit(Cast cast, Object param) {
 		...
 		predicate(!cast.getTarget().getClass().equals(ArrayType.class),
 				"No se puede convertir un array",cast);
 		predicate(!cast.getTarget().getClass().equals(NomType.class),
 				"No se puede convertir un struct",cast);
 		predicate(!cast.getTipo().getClass().equals(cast.getTarget().getClass()),
 	...
 	public Object visit(Not not, Object param) {
 		...
 		predicate(not.getExpr().getType().getClass().equals(IntType.class),
 				"No se puede negar un operador que no sea un entero",not);
 	...
 	public Object visit(FunctionCall functionCall, Object param) {
 		...
 		predicate(!(functionCall.getExprs().size()!=functionCall.getFunction().parametros().count()),
 				"El número de parametros que se le pasan a la llamada de la función no son los mismos que se especificaron en su declaración",
 				functionCall);
